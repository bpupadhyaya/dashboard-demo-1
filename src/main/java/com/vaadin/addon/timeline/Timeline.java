...
public class Timeline extends AbstractComponent implements LegacyComponent {
    ...
    // Marker container
    protected Indexed markers;

    // Event container
    protected Indexed events;
     ...
     */
    public class DateRangeChangedEvent extends Event {
         ...
         * See {@link Event} for more details.
         * 
         * @param source
     ...
     * 
     */
    public class EventButtonClickEvent extends Event {

        private List<Object> ids;

        /**
         * See {@link Event} for details.
         * 
         * @param source
         *            The source of the event
         */
     ...
     */
    @Deprecated
    public void addGraphDataSource(Indexed dataSource) {
        /*
     ...
     */
    public void removeGraphDataSource(Indexed dataSource) {
        if (dataSource == null) {
     ...
     */
    @Deprecated
    public void setMarkerDataSource(Indexed markers) {
     ...
     */
    public Indexed getMarkerDataSource() {
        return markers;
    }
     ...
     */
    @Deprecated
    public void setEventDataSource(Indexed events) {
     ...
     */
    public Indexed getEventDataSource() {
        return events;
    }
     ...
     */
    public void setGraphOutlineColor(Indexed dataSource,
            SolidColor color) {
     ...
     *            The data source of the graph
     */
    public SolidColor getGraphOutlineColor(Indexed dataSource) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
            return ds.getColor();
        }
     ...
     */
    public void setGraphFillColor(Indexed dataSource, SolidColor color) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
            if (color == null) {
     ...
     *            The data source of the graph
     */
    public SolidColor getGraphFillColor(Indexed dataSource) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
     ...
     */
    public void setBrowserOutlineColor(Indexed dataSource,
            SolidColor color) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
            if (color == null) {
     ...
     *            The data source of the graph
     */
    public SolidColor getBrowserOutlineColor(Indexed dataSource) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
     ...
     */
    public void setBrowserFillColor(Indexed dataSource,
            SolidColor color) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
            if (color == null) {
     ...
     *            The data source of the graph
     */
    public SolidColor getBrowserFillColor(Indexed dataSource) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
     ...
     */
    @Deprecated
    public void setGraphLegend(Indexed dataSource, String caption) {
     ...
     */
    public void setGraphCaption(Indexed dataSource, String caption) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
     ...
     *            The data source of the graph
     */
    public String getGraphCaption(Indexed dataSource) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
     ...
     */
    public void setGraphVisibility(Indexed dataSource,
            boolean visibility) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
     ...
     *            The data source of the graph
     */
    public boolean getGraphVisibility(Indexed dataSource) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
            return ds.isVisible();
        }
    ...
    protected void fireDateRangeChangedEvent(Date start, Date end) {
        getLogger().finest(
                "Firing a date range changed event with dates " + start + " - "
                        + end);
        fireEvent(new DateRangeChangedEvent(this, start, end));
    }
    ...
    protected void fireEventButtonClickEvent(List<Object> itemIds) {
        ...
        fireEvent(new EventButtonClickEvent(this, itemIds));
    }
     ...
     *            The unit
     */
    public void setVerticalAxisLegendUnit(Indexed dataSource,
            String unit) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
            if (unit == null) {
     ...
     *            The data source of the graph
     */
    public String getVerticalAxisLegendUnit(Indexed dataSource) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
     ...
     *            The timestamp property id
     */
    public void setGraphTimestampPropertyId(Indexed dataSource,
            Object id) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
     ...
     * @return The timestamp property id
     */
    public Object getGraphTimestampPropertyId(Indexed dataSource) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
     ...
     */
    @Deprecated
    public void setGraphValueProperyId(Indexed dataSource, Object id) {
     ...
     *            The value property id
     */
    public void setGraphValuePropertyId(Indexed dataSource, Object id) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
            Class<?> clazz = dataSource.getType(id);
     ...
     * @return the id
     */
    public Object getGraphValueProperyId(Indexed dataSource) {
        TimelineDatasourceProperties ds = getDatasourceProperties(dataSource);
        if (ds != null) {
     ...
     */
    public void setGraphCapsVisible(Indexed graph, boolean visible) {
     ...
     * @return The line caps state
     */
    public boolean isGraphCapsVisible(Indexed graph) {
        if (graph == null) {
            throw new IllegalArgumentException(
     ...
     *            value)
     */
    public void setGraphOutlineThickness(Indexed graph,
            double thickness) {
        if (thickness <= 0) {
            throw new IllegalArgumentException("Thickness must be positive");
        }
     ...
     * @return
     */
    public double getGraphOutlineThickness(Indexed graph) {
        TimelineDatasourceProperties ds = getDatasourceProperties(graph);
        if (ds != null) {
    ...
    public List<Indexed> getGraphDatasources() {
        List<Indexed> graphs = new ArrayList<Indexed>();
